...
result1='https://www.indeed.com.mx/trabajo?q=Supervisor+de+produccion&l=Edo.+de+M%C3%A9xico'
result2='https://www.indeed.com.mx/jobs?q=Supervisor+de+produccion&l=Edo.+de+M%C3%A9xico&start=10'
result3='https://www.indeed.com.mx/jobs?q=Supervisor+de+produccion&l=Edo.+de+M%C3%A9xico&start=20'
result4='https://www.indeed.com.mx/jobs?q=Supervisor+de+produccion&l=Edo.+de+M%C3%A9xico&start=30'
result5='https://www.indeed.com.mx/jobs?q=Supervisor+de+produccion&l=Edo.+de+M%C3%A9xico&start=40'
...
for t ,s in zip(title1,salario1):
    name1= t.a.get_text()
    salary1=s.get_text()
    if 'Produccion ' or 'produccion' in name1 and '0' in salary1:
        print(name1,salary1.replace('$' ,' '))
    else:
        print("no date")
...
for ti,sa in zip(title2,salario2):
    name2= ti.a.get_text()
    salary2=sa.get_text()
    if 'Produccion ' or 'produccion'in name2 and '0' in salary2:
...
for tit,sal in zip(title3,salario3):
    ...
    if 'Produccion ' or 'produccion' in name3 and '0' in salary3:
...
for titi,sala in zip(title4,salario4):
    ...
    if 'Produccion ' or 'produccion'  in name4 and '0' in salary4:
        print(name4,salary4.replace('$' ,' '))
    else:
        print("no date")
...
for titl,salar in zip(title5,salario5):
    ...
    if 'Produccion ' or 'produccion'  in name5 and '0' in salary5:
        print(name5,salary5.replace('$' ,' '))
    else:
        print("no date")
